        ...
        return (
          <div key={index} className='py-4 border-t border-b text-gray-700 grid grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4'>
              <div className='mt-3 flex'>
                   ...
                   <div className='mt-2 text-sm sm:text-lg font-medium '>
              ...
              <input onChange={(e)=>e.target.value === '' || e.target.value === '0' ? null : updateQuantity(item._id,item.size,Number(e.target.value)) } className='border max-w-10 h-10 sm:max-w-20 px-1 sm:px-2 py-1 mt-2' type="number" defaultValue={item.quantity} />
